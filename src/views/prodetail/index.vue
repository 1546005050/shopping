  ...
  <div class="prodetail">
    ...
    <div class="info">
      <div class="title">
        ...
        <div class="sellcount">{{detail.goods_sales
}}</div>
      </div>
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in plList" :key="item.comment_id">
          <div class="top">
...
<script>
import { Sp } from '@/api/shopping'
import { Pl } from '@/api/pl'
...
export default {
  ...
  methods: {
    ...
    async getDetail () {
      const { data: { detail } } = await Sp(this.goodsId)
      this.detail = detail
      this.images = detail.goods_images
      console.log(this.images)
    },
    async PIl () {
      const { data: { list, total } } = await Pl(this.goodsId, 4)
      this.plList = list
      this.total = total
    },
    Add () {
